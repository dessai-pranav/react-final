...
switch(action.type){
    ...
    case "account/requestLoan" : if(state.loan>0) return state; return {...state,loan: action.payload.amount,loanPurpose:action.payload.purpose,balance:state.balance + action.payload.amount}
...
store.dispatch(createCustomer("pranav gauns dessai","121332"))
store.dispatch(updateName("pranav gauns desai"))