  ...
  render() {
    return (
      <div className="app">
        ...
        {this.state.isLoading && <p className="loader">Loaading..</p>}
  ...
  render(){
    ...
    return <div>
      ...
      <ul className="weather">
        {dates.map((date,i)=> <Day date={date} max={max.at(i)} min={min.at(i)} code={codes.at(i)} key={date}/>)}
      </ul>
    </div>
  }
}
...
class Day extends React.Component{
  render(){
    ...
    return <li className="day"><span>{getWeatherIcon(code)}</span><p>{formatDay(date)}</p>
    <p>{Math.floor(min)}&deg; &mdash; {Math.floor(max)}&deg;</p>
    <p></p></li>
  }
